		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if(txtFechaEntrada.getDate()!=null && txtFechaSalida.getDate()!=null) {
					dias = (int)(txtFechaSalida.getDate().getDate()-txtFechaEntrada.getDate().getDate());	
					txtValor.setText(dias*precioDia+"");
				}
			}
		});
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {		
					...
					Reserva reserva = new Reserva(txtFechaEntrada.getDate(), txtFechaSalida.getDate(),Double.parseDouble(txtValor.getText())  , txtFormaPago.getSelectedIndex());
					
					ReservadoController reservadoController = new ReservadoController();
					String respuesta= reservadoController.guardar(reserva);
					
					if ( isNumeric( respuesta) ) {
						RegistroHuesped registro = new RegistroHuesped(Integer.parseInt(respuesta));
						JOptionPane.showMessageDialog(null, "Tú reserva se realizado exitosamente!!!");
						reserva.setId(Integer.parseInt(respuesta));
