...
public class Login extends JFrame {
	...
	private void Login() {
	     ...
	     //String Contraseña="admin";
	        ...
	        String resultado = usuarioController.seleccionar(txtUsuario.getText(), contrase);
	        if (isNumeric(resultado)==true && Integer.parseInt(resultado) == 1) {
	        	MenuUsuario menu = new MenuUsuario();
	            menu.setVisible(true);
	            dispose();
	        }else if (isNumeric(resultado)==true && Integer.parseInt(resultado) == 0){
	        	JOptionPane.showMessageDialog(this, "Usuario o Contraseña no válidos");
	        }else {
