...
public class RegistroHuesped extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistroHuesped frame = new RegistroHuesped(5);
	...
	public RegistroHuesped(int Id) {
		...
		//txtNreserva.setText(this.reserva+" 00");
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (txtNombre.getText()=="") {
					JOptionPane.showMessageDialog(null, "Por favor rellena el nombre");
					return;
				}
				if(txtApellido.getText()==""){
					JOptionPane.showMessageDialog(null, "Por favor rellenar el apellido");
					return;
				}
				if(txtFechaN.getDate()==null) {
					JOptionPane.showMessageDialog(null, "Por favor ingresa la fecha de nacimiento");
					return;
				}
				...
				Huesped huesped = new Huesped( txtNombre.getText(), txtApellido.getText(), txtFechaN.getDate(),txtNacionalidad.getSelectedIndex(), Integer.parseInt(txtTelefono.getText()) , Integer.parseInt(txtNreserva.getText()));
				
				HuespedController huespedController = new HuespedController();
				String respuesta = huespedController.Guardar(huesped);
				if ( isNumeric( respuesta) ) {
					JOptionPane.showMessageDialog(null, "Tú reserva se realizado exitosamente!!!");
